...
[![Greenkeeper badge](https://badges.greenkeeper.io/dyygtfx/lodash-zh.svg)](https://greenkeeper.io/)

发现国内有 underscore 的文档，但是没有 lodash 的，因为平时自己要用，所以只能自己动手来弄下 lodash 中文文档
